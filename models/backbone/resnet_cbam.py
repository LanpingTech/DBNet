...
__all__ = ['ResNet', 'resnet18_cbam', 'resnet34_cbam', 'resnet50_cbam', 'resnet101_cbam', 'deformable_resnet18_cbam', 'deformable_resnet50_cbam',
           'resnet152_cbam']
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, dcn=None, use_cbam=True):
        ...
        self.stride = stride
        self.cbam = CBAM(planes) if use_cbam else nn.Identity()
...
def deformable_resnet18_cbam(pretrained=True, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def deformable_resnet50_cbam(pretrained=True, **kwargs):
...
if __name__ == '__main__':
    ...
    net = deformable_resnet50_cbam(pretrained=False)
    y = net(x)
    for u in y:
        print(u.shape)
